...
def main():
    ...
    parser.add_argument('-startviewer', dest='startViewer', action='store_true',
                        default=False, help='Start viewer as a thread.')
    ...
    # Start viewer thread
    if args.startViewer:
        nbthread.startViewerThread(args.serverPort)
